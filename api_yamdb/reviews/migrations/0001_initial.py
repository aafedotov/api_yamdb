# Generated by Django 2.2.16 on 2022-02-01 17:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('genre', models.ManyToManyField(help_text='Select a genre for this work', related_name='titles', to='reviews.Genre')),
            ],
        ),
        migrations.CreateModel(
            name='Review',
